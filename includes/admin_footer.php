        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <ul class="list-unstyled">
                    <li><a href="pages/admin/dashboard.php" class="text-white">Dashboard</a></li>
                    <li><a href="../admin/members_manage.php" class="text-white">Members</a></li>
                    <li><a href="../admin/loans_manage.php" class="text-white">Loans</a></li>
                    <li><a href="../admin/projects_manage.php" class="text-white">Projects</a></li>
                    <li><a href="../admin/reports.php" class="text-white">Reports</a></li>
                </ul>
            </div>
